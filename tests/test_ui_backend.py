...
class TestUIBackendAPI:
    ...
    def client(self):
        ...
        Returns:
            test_client (TestClient): A TestClient bound to the application `app`.
        """
        return TestClient(app)

    def test_health_endpoint(self, client):
        """
        Verify that the /health endpoint responds with HTTP 200 and JSON {"status": "ok"}.
        
        Parameters:
            client (TestClient): FastAPI TestClient instance used to make requests.
        """
    ...
    def test_instruments_subscribed(self, client):
        """
        Verify the /instruments/subscribed endpoint responds with HTTP 200 and returns a JSON list.
        
        Asserts that the response status code is 200 and the response body is a JSON array.
        """
